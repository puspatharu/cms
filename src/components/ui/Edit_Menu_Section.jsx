...
function Edit_Menu_Section({closepop}) {
          ...
          return (
            <Form >
              <div className='flex flex-col capitalize gap-3 px-15 py-5 w-full  '>
                ...
                <button type='submit' onClick={closepop} className='border-1.5 border-black rounded-xl w-fit  px-3 py-1 bg-red-400 text-white font-medium'>Cancel</button>
